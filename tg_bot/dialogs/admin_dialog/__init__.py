...
from tg_bot.dialogs.admin_dialog.structure_dialog.addingwindows import (
    enter_article_name, enter_article_url, enter_category_for_article,
    enter_category_name, enter_project_abbreviation,
    enter_project_for_category, enter_project_name, except_adding)
